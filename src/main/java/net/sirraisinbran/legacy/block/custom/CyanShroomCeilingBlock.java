...
public class CyanShroomCeilingBlock extends OtherworldMushroomPlant {

    protected static final VoxelShape SHAPE = Block.createCuboidShape(5.0D, 6.5D, 5.0D, 11.0D, 16.0D, 11.0D);

    public CyanShroomCeilingBlock(Settings settings, Supplier<RegistryEntry<? extends ConfiguredFeature<?, ?>>> feature) {

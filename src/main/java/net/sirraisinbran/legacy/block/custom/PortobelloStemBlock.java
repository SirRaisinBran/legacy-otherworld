...
public class PortobelloStemBlock extends Block implements Waterloggable {
    ...
    public PortobelloStemBlock(Settings settings) {
        super(settings);
    ...
    private boolean northCheck(BlockState state, BlockView world, BlockPos pos){
        ...
        return blockState.isOf(LegacyBlocks.PORTOBELLO_STEM);
    }
    ...
    public BlockState getPlacementState(ItemPlacementContext ctx) {
        ...
        boolean bl2 = blockState.isOf(LegacyBlocks.PORTOBELLO_STEM);
        boolean bl3 = blockState2.isOf(LegacyBlocks.PORTOBELLO_STEM);
        boolean bl4 = blockState3.isOf(LegacyBlocks.PORTOBELLO_STEM);
        boolean bl5 = blockState4.isOf(LegacyBlocks.PORTOBELLO_STEM);
        boolean bl6 = !blockState5.isOf(LegacyBlocks.PORTOBELLO_STEM);
        boolean bl7 = !blockState6.isOf(LegacyBlocks.PORTOBELLO_STEM);
